    ...
    return (
        ...
        <Formik
            ...
            onSubmit={async (values, { resetForm }) => {
                ...
                dispatch(startNuevaOrden(formulario))
            }}
        >
            {
                ({ touched, handleSubmit, getFieldProps, errors, resetForm, values }) => (
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid container item spacing={2} sm={6}>
                                <Typography component="h1" variant="h5" width={'100%'} mt={2} align='center'>
                                    Direccion remitente (desde donde)
                                </Typography>
                                <Grid item xs={12} sm={6}>
                                    <TextField
                                        ...
                                        error={!!touched.puntoOrigen?.calle && !!errors.puntoOrigen?.calle}
                                        {
                                        ...getFieldProps('puntoOrigen.calle')
                                        }
                                    />
                                    {
                                        (touched.puntoOrigen?.calle && errors.puntoOrigen?.calle) && (
                                            <Typography component="p" sx={{
                                                color: 'error.main'
                                            }} mt={1}>
                                                {errors.puntoOrigen?.calle}
                                            </Typography>
                                        )
                                    }
                                </Grid>
                                <Grid item xs={12} sm={6}>
                                    <TextField
                                        ...
                                        error={!!touched.puntoOrigen?.numero && !!errors.puntoOrigen?.numero}
                                        {
                                        ...getFieldProps('puntoOrigen.numero')
                                        }
                                    />
                                    {
                                        (touched.puntoOrigen?.numero && errors.puntoOrigen?.numero) && (
                                            <Typography component="p" sx={{
                                                color: 'error.main'
                                            }} mt={1}>
                                                {errors.puntoOrigen?.numero}
                                            </Typography>
                                        )
                                    }
                                </Grid>
                                <Grid item xs={12}>
                                    <Tooltip title='Ciudades donde trabajamos!' placement='right'>
                                        ...
                                        <TextField
                                            ...
                                            error={!!touched.puntoOrigen?.ciudad && !!errors.puntoOrigen?.ciudad}
                                            {
                                            ...getFieldProps('puntoOrigen.ciudad')
                                            }
                                        >
                                            {
                                                ciudades.map(ciudad => (
                                    ...
                                    {
                                        (touched.puntoOrigen?.ciudad && errors.puntoOrigen?.ciudad) && (
                                            <Typography component="p" sx={{
                                                color: 'error.main'
                                            }} mt={1}>
                                                {errors.puntoOrigen?.ciudad}
                                            </Typography>
                                        )
                                    }
                                </Grid>
                                <Grid item xs={12}>
                                    ...
                                    <TextField
                                        ...
                                        error={!!touched.puntoOrigen?.infoAdicional && !!errors.puntoOrigen?.infoAdicional}
                                        {
                                        ...getFieldProps('puntoOrigen.infoAdicional')
                                        }
                                    />
                                    {
                                        (touched.puntoOrigen?.infoAdicional && errors.puntoOrigen?.infoAdicional) && (
                                            <Typography component="p" sx={{
                                                color: 'error.main'
                                            }} mt={1}>
                                                {errors.puntoOrigen?.infoAdicional}
                                            </Typography>
                                        )
                                    }
                                </Grid>
